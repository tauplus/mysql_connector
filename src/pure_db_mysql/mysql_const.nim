...
type CACHING_SHA2_PASSWORD_STATUS* = enum
  CACHING_SHA2_REQUEST_PUBLIC_KEY = 0x02.byte
  CACHING_SHA2_FAST_AUTH_SUCCESS = 0x03.byte
  CACHING_SHA2_PERFORM_FULL_AUTHENTICATION = 0x04.byte